...
export function workspaceInvitationEmail(options: {
  ...
  const { workspaceName, inviterName, role, url } = options;
          ...
          <tr>
            <td style="padding: 0 48px;">
              <p style="margin: 0 0 16px 0; font-size: 16px; line-height: 1.5; color: #51545e;">
                ${safeInviter} has invited you to join <strong>${safeName}</strong> as a <strong>${safeRole}</strong>.
              </p>
              <p style="margin: 0 0 16px 0; font-size: 16px; line-height: 1.5; color: #51545e;">
          ...
          <tr>
            <td style="padding: 24px 48px; background-color: #f4f4f7; border-top: 1px solid #eaeaec;">
              <p style="margin: 0; font-size: 13px; line-height: 1.5; color: #9a9ea6; text-align: center;">
                You received this email because ${safeInviter} invited you to join ${safeName}.
              </p>
            </td>
          </tr>
        </table>
