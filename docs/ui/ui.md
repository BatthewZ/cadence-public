...
| [usePatchTaskMutation](hooks.md#usepatchtaskmutation)      | Optimistic `PATCH /api/tasks/:taskId` that patches every task-bearing cache up front and quiet-invalidates stats, shared between TaskDetailDialog and TaskDetailPanelInner |
